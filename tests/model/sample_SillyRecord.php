...
class sample_SillyRecordPropertyGenerator extends repose_AbstractPropertyGenerator {
    public function generate(repose_Session $session, repose_MappedClass $clazz, repose_MappedClassProperty $property, $object, $newId = null) {
        return 'SILLY-' . $object->name;
    }
    public function shouldGenerateBeforePersist() { return true; }
}
